...
Here we are going to learn **how to use R** to address all these questions, according to the needs of applied epidemiologists.

## Learning objectives

1.  Define **geospatial analysis**.

2.  Identify the main analytical tasks that **GIS software** can solve.

3.  Identify the **advantages** of using R as GIS software.
...
A geospatial analysis can help us to:
...
-   Determine the **accessibility of** **healthcare** for people that need it.
