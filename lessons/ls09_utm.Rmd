...
To illustrate this scenario, we are going to use **malaria prevalence in The Gambia**. We use data of malaria prevalence in children obtained at **65 villages** in The Gambia.
...
**Projected CRS** are a choice made by a *public mapping agencies.* So, with local data sources, it is better to work with the CRS in which the data was provided to ensure *compatibility*, even if the official CRS is not the most accurate.
:::
