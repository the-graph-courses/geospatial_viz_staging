...
mute(here("ch06_basic_geospatial_viz/lessons/ch06_ls10_layers_autograder.R"))
```
...
We will create a map to figure out how are Tier 3 Hospitals distributed in the Western Province of Sierra Leone. For this, we are going to retrieve real Hospital information from a public repository.
...
sites_sf <- readr::read_csv(
  here("ch06_basic_geospatial_viz/data/gps_healthsites.csv")) %>% 
