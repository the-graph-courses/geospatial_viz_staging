...
::: practice
Run this code to read Raster data. First, use `{here}` to specify the file path. Then, use `{terra}` to read the `.tif` file inside the `ch06_basic_geospatial_viz/data/gis/` folder:
