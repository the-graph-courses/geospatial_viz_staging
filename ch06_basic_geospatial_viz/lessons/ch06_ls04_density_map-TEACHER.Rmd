...
suppressMessages(source(here::here("ch06_basic_geospatial_viz/lessons/ch06_ls04_density_map_autograder.R")))
```
...
```{r}
pcrime <- read_rds(here("ch06_basic_geospatial_viz/data/pcrime.rds"))
```
