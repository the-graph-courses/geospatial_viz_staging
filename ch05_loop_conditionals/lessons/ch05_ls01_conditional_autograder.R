...
.hint_q1 <- function(){ 
"Remember that the code after the `if` statement is executed only when the condition is TRUE" %>% cat() }
...
.hint_q2 <- function(){ 
"Remember that the code after the `if` statement is executed only when the condition is TRUE,
and the code after the `else` statement is executed only when the condition is FALSE." %>% cat() }
...
.hint_q3 <- function(){ 
"Remember that the order of the code blocks in an `if/else if/else` statement is important!" %>% cat() }
